...
func getTheBestTactic(myCoords game.Point, destination game.Point, b *game.Board) string {
	...
	// e := b.GetAllPoints(game.AI_TANK_DOWN, game.AI_TANK_LEFT, game.AI_TANK_PRIZE, game.AI_TANK_RIGHT, game.AI_TANK_UP, game.OTHER_TANK_DOWN, game.OTHER_TANK_LEFT, game.OTHER_TANK_RIGHT, game.OTHER_TANK_UP)
}